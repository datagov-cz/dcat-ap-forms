...
export default {
  ...
  "help_dataset_ofn": "<h3>Specifikace</h3><p>Pokud se datová sada řídí <a href=\"https://ofn.gov.cz\"  target=\"_blank\">otevřenými formálními normami a sdílenými specifikacemi</a>, uveďte jejich URL (s verzí, diakritikou a lomítkem na konci, např. <code>https://ofn.gov.cz/turistické-cíle/2020-07-01/</code>). Jen tak je v NKOD najdou příslušné aplikace. Volitelně lze zadat další URL specifikací, kterými se datová sada řídí.</p>",
  ...
  "help_license_author_type": "<h3>Autorské dílo</h3><p>Tato položka se řídí <a href=\"https://data.gov.cz/pro-poskytovatele/otevřená-data/stanovení-podmínek-užití/#autorská-práva\" target=\"_blank\">podrobným návodem</a>. Její správné vyplnění je stěžejní pro to, aby byla mohla být distribuce datové sady považována za otevřenou. Věnujte tedy jejímu vyplnění maximální pozornost. Pokud zvolíte položku &quot;Obsahuje více autorských děl&quot;, ujistěte se, že pro každé autorské dílo v distribuci je otevřená licence řádně specifikována.</p>",
  ...
  "help_license_specialdb_type": "<h3>Zvláštní právo pořizovatele databáze</h3><p>Tato položka se řídí <a href=\"https://data.gov.cz/pro-poskytovatele/otevřená-data/stanovení-podmínek-užití/#zvláštní-práva-pořizovatele-databáze\" target=\"_blank\">podrobným návodem</a>. Její správné vyplnění je stěžejní pro to, aby byla mohla být distribuce datové sady považována za otevřenou. Věnujte tedy jejímu vyplnění maximální pozornost.</p>",
  ...
  "load_url": "Načíst záznam z URL",
  "url_title": "URL záznamu datové sady",
  ...
  "hvd_categories_autocomplete_no_data": "Začněte psát název kategorie HVD. Do září 2024 jsou k dispozici pouze anglické názvy.",
  "distribution_legislation": "Příslušné právní předpisy distribuce",
  "missing_distribution_with_hvd": "Alespoň jedna distribuce musí mít příslušný právní předpis High Value Datasets, pokud má být datová sada samotná High Value Dataset.",
